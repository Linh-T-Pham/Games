...
This corresponds to the alpha-number system in traditional chess while being computationally useful. they are specified as tuples
"""
import itertools
WHITE = "white"
BLACK = "black"
...
"""game class. has the following members and methods:
    ...
    and moves the piece if it is. if the move conflicts with another piece, that piece is removed. ischeck(mate) is run, 
...
class Game:
    ...
    def isCheck(self):
        ...
        # To determine where the kings are, I need to check all pieces of opposing color against those kings, 
        # then if the white King or black King gets hit then
        # check if it is checkmate
        # A function for checkmate should be inside of the Game board
        # Then inside this function, I can have have_seen_King helper function which,
        # keep tracking of white king and black king's position


        king = King
        kingDict = {} # the piece.Color is key and position is value 
    ...
    def canSeeKing(self,kingpos,piecelist):
        ...
        for piece,position in piecelist:
            if piece.isValid(position,kingpos,piece.Color,self.gameboard): #isValid helper function to check valid move which is in the Class Piece 
                return True
